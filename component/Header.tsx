...
export default function Header() {
    return (
        <header className="bg-gray-800 shadow-sm w-full">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center">
                        <Link href="/" className={`text-xl text-violet-500 ${logoFont.className}`}>Amuge<br />Games</Link>
                        <div className="ml-8 relative hidden md:block">
                            <input type="text" placeholder="검색어를 입력하세요." className="w-96 h-10 pl-10 pr-4 rounded-full bg-gray-700 text-sm text-gray-100 placeholder-gray-400 border-none focus:outline-none" />
